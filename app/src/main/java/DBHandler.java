...
public class DBHandler extends SQLiteOpenHelper {
    ...
    // Contacts table name
    private static final String TABLE_PROTOTCOL = "protocol";

    // Contacts Table Columns namesrial
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_PROTOCOL_TABLE = "CREATE TABLE " + TABLE_PROTOTCOL + "("
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_PROTOTCOL);
